                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    while($data = mysqli_fetch_assoc($result))
                                    {
                                       echo '<tr>
                                        ...
                                        <td>'.$data['name'].'</td>
                                        <td>'.$data['email'].'</td>'?>
                                        <td><button class="rol"><?php echo $data['roles']?></button></td>
                                        <?php echo '<td>'.$data['time'].'</td>
                                        <td>
                                        <a href="edit-addrole.php?edit_id='.$data['id'].'"><button class="btn btn-danger mb-2">Edit</button></a> 
                                        <a href="updateaddrole.php?del_id='.$data['id'].'"><button class="btn btn-danger mb-2">Delete</button></a> 
                                        </td>
                                        </tr>';
                                        ?>
                                     <?php
                ...
                <div id="emp_table">
                    <div class="modal-body">
                        <div class="container py-2">
                            <form id="myform" method="POST" enctype="multipart/form-data" action="addeditrole.php">
                            <div class="form-group">
                                <label for="name">Name:</label>
                                <select class="form-control" name="name" id="nameid">
                                <?php
                                    $conn = mysqli_connect($servername, $username,$password,$dbname);
                                    ...
                                    while($data = mysqli_fetch_assoc($result))
                                    {
                                        echo'<option value="'.$data['admin_name'].'">'.$data['admin_name'].'</option>';
                                    }
                                ?>    
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="email" id="emailid">
                                <?php
                                    $conn = mysqli_connect($servername, $username,$password,$dbname);
                                    $query ="SELECT * FROM admin";
                                    $result = mysqli_query($conn,$query);
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    $conn = mysqli_connect($servername, $username,$password,$dbname);
                                    $query ="SELECT * FROM create_role";
                                    $result = mysqli_query($conn,$query);
                                    while($data = mysqli_fetch_assoc($result))
                                    {
                                        echo'<option value="'.$data['role_name'].'">'.$data['role_name'].'</option>';
                                    }
                                ?>    
                                </select>
                            </div>
