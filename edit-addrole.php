                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                           ...
                           <form method="post" action="updateaddrole.php">
                            <div class="form-group">
                            <input type="hidden" name="postid" id="postid" value="<?php echo $_GET['edit_id'];?>">
                            <label for="name">Name:</label>
                            <input type="text" class="form-control" name="name" id="nameid" value="<?php echo $data['name'];?> " readonly>
                            </div>
                            <div class="form-group">
                            <label for="email">Email:</label>
                            <input type="text" class="form-control" name="email" id="emailid" value="<?php echo $data['email'];?> " readonly>
                            </div>
                            <div class="form-group">
                            <label for="role">Roles:</label><br/>
                            <?php
                                $conn = mysqli_connect($servername, $username,$password,$dbname);
                                $query ="SELECT role_name FROM create_role";
                                $result = mysqli_query($conn,$query);
                                // if(mysqli_num_rows($result)>0){
                                while($data = mysqli_fetch_array($result))
                                {   
                            ?>   
                            <input type="checkbox" id="roleid" name="role[]" value="<?php echo $data['role_name']; 
                           ?> " <?php if(($data['role_name']))
                           {
                            echo 'checked';
                           }else{
                            echo '';
                           }?>> <?php echo $data['role_name']?><br/>
                            <?php
                                // }
                            }
                            ?>
