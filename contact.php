                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Contact DataTables </h6>
                        </div>
                        <div class="card-body">
                        <div>
                                   ...
                                   <?php $i=1;
                                    while($data = mysqli_fetch_assoc($result))
                                    {
                                       echo '<tr>
                                            ...
                                            <td>'.$data['time'].'</td>
                                            <td>
                                            <a href="editcontact.php?edit_id='.$data['id'].'"><button class="btn btn-success mb-2">Edit</button></a> 
                                            <a href="updatecontact.php?del_id='.$data['id'].'"><button class="btn btn-danger mb-2">Delete</button></a>
                                            </td>
                                        </tr>';
                                     $i++;
                                    }
                ...
                <div id="emp_table">
                    <div class="modal-body">
                        <div class="container py-2">
                            <form id="myform" method="POST" action="contactcode.php">
