                                   ...
                                   <?php $i=1;
                                    while($data = mysqli_fetch_assoc($result))
                                    {
                                       echo '<tr>
                                            ...
                                            ?>
                                         <td><img src="Users/images/portfolio/<?php echo $data['images']?>" height="80" width="80"></td>
                                            <?php
                                            echo '<td>'.$data['time'].'</td>
                                            <td>
                                            <a href="editportfolio.php?edit_id='.$data['id'].'"><button class="btn btn-success mb-2">Edit</button></a> 
                                            <a href="updateportfolio.php?del_id='.$data['id'].'"><button class="btn btn-danger mb-2">Delete</button></a>
                                            </td>
                                        </tr>';
                                     $i++;
                                    }
                ...
                <div id="emp_table">
                    <div class="modal-body">
                        <div class="container py-2">
                            <form id="myform" method="POST" enctype="multipart/form-data" action="portfoliocode.php">
