                                    ...
                                    while($data = mysqli_fetch_assoc($result))
                                    {
                                       echo '<tr>
                                         ...
                                         <td><img src="Users/images/<?php echo $data['images']?>" height="80" width="80"></td>
                                            ...
                                            <td>
                                            <a href="editteam.php?edit_id='.$data['id'].'"><button class="btn btn-success mb-2">Edit</button></a> 
                                            <a href="updateteam.php?del_id='.$data['id'].'"><button class="btn btn-danger mb-2">Delete</button></a>
                                            </td>
                                        </tr>';
                                     $i++;
                                    }
                ...
                <div id="emp_table">
                    <div class="modal-body">
                        <div class="container py-2">
                            <form id="myform" method="POST" enctype="multipart/form-data" action="teamcode.php">
