                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Employees DataTables </h6>
                        </div>
                        <div class="card-body">
                        <div>
                                   ...
                                   <?php $i=1;
                                    while($data = mysqli_fetch_assoc($result))
                                    {
                                       echo '<tr>
                                            ...
                                            <td>'.$data['gender'].'</td>'
                                            ?>
                                         <td><img src="images/<?php echo $data['emp_img']?>" height="80" width="80"></td>
                                            <?php
                                            echo '<td>'.$data['time'].'</td>
                                            <td>
                                            <a href="emp-edit-table.php?edit_id='.$data['emp_id'].'"><button class="btn btn-success mb-2">Edit</button></a> 
                                            <a href="emptableaction.php?del_id='.$data['emp_id'].'"><button class="btn btn-danger mb-2">Delete</button></a> 
                                            </td>
                                        </tr>';
                                     $i++;
                                    }
                ...
                <div id="emp_table">
                    <div class="modal-body">
                        <div class="container py-2">
                            <form id="myform" method="POST" enctype="multipart/form-data" action="empinsert.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pass" class="form-control" id="passid"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="age" class="form-control" id="ageid"/>
                            </div>
                            <div class="form-group">
