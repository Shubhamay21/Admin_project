...
$id = $_GET['edit_id'];
$sql = "SELECT * from create_role where id='".$id."'";
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                           ...
                           <form method="post">
                            ...
                            <input type="text" class="form-control" id="nameid" value="<?php echo $data['role_name'];?>" >
                            </div>
                            <div class="form-group">
...
?>
    <script src="js/dash/update-role.js"></script>
