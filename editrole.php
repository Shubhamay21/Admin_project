                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"> New Roles</h6>
                        </div>
                        <div class="card-body">
                        <div>
                            ...
                            <div id="load" class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    while($data = mysqli_fetch_assoc($result))
                                    {
                                       echo '<tr>
                                        <td>'.$i.'</td>'?>
                                        <td><button class="rol"><?php echo $data['role_name']?></button></td>
                                        <?php echo '<td>'.$data['time'].'</td>
                                        <td>
                                        <a href="editroles.php?edit_id='.$data['id'].'"><button class="btn btn-danger mb-2">Edit</button></a> 
                                        <a href="updaterole.php?del_id='.$data['id'].'"><button class="btn btn-danger mb-2">Delete</button></a> 
                                        </td>
                                        </tr>';
                                        ?>
                                     <?php
...
?>
    <script src="js/dash/edit-role.js"></script>
