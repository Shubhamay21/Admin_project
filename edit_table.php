                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                           ...
                           <form method="post">
                            ...
                            <input type="text" class="form-control" id="nameid" value="<?php echo $data['admin_name'];?>" >
                            </div>
                            <div class="form-group">
                            <label for="email">Email:</label>
                            <textarea class="form-control" id="emailid"><?php echo $data['email'];?></textarea>
                            </div>
                            <div class="form-group">
                            <label for="pwd">Password:</label>
                            <textarea class="form-control" id="passid"><?php echo $data['password'];?></textarea>
                            </div>
                            <div class="form-group">
...
?>
<script src="js/dash/edit-tables.js"></script>